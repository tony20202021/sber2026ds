...
# All candidates (deduplicated, in X_train)
candidates = [c for c in X_train.columns]
print(f"Total candidate features: {len(candidates)}")

# ── Step 1: single LGB → importance → top-200 ────────────────────────────────
...
# Which feature groups made it into top-200?
